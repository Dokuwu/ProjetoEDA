...
int main() {
	...
	char nickname[20], password[20], tipo[20], geocod[50],adminnome[20],adminsenha[20],utilnome[50],utilmorada[50];
					...
					while (exec) {
						...
						if (choice == 1) {
							...
							if (utiladminmeio == 1) {//utilizador
								printf("Nome\n");
								scanf("%s", utilnome);//NAO ESTÁ A FUNCIONAR!!!!! NÃO COPIA UM NOME INTEIRO
								printf("\nNIF:\n");
								scanf("%d", &utilNIF);
								printf("\nMorada:\n");
								scanf("%s", utilmorada);//NAO ESTÁ A FUNCIONAR!!!!! NÃO COPIA UMA MORADA INTEIRA
								printf("\nSaldo\n");
								scanf("%f", &utilsaldo);
								system("cls");
